<?php
/**
*	Description:获取微端礼包数据，从t_log_weiduan_tip_libao表中读取数据
*/
...
try {
	...
	$sql = "SELECT mdate,mtime, uuid, account_name, role_name, pf, type, libaoID,year,month,day,hour,min
			FROM $table
