...
try {
        $sql = "select mdate,mtime,uuid,account_name,role_name,max(level) as level,zhandouli,wingname,rank,year,month,day  from t_log_billboard_wing  where mtime >={$beginTime} and mtime<={$endTime} group by account_name";	
