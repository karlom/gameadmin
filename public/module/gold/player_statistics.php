...
{  
	...
	$topMenCountIndex 	= 0;//保存最大人数的索引值
	$topGoldCountIndex 	= 0;//保存最大元宝数的索引值
	$topMenCountday 	= ceil(( $startTime - $openTimestamp ) / 86400) + 1;//保存最大人数的天数（从开服起）
	$topGoldCountday 	= ceil(( $startTime - $openTimestamp ) / 86400) + 1;//保存最大元宝数的天数（从开服起）
	$topMenCount		= 0;//最大人数
...
$smarty->display( 'module/gold/player_statistics.tpl' );