...
$condArrAllOut =  array( $moneyPlus, ' type not in (30002,30003,30018,30019,30020) ');
$output_all = getData($startDateTimestamp, $endDateTimestamp, $condArrAllOut);
insertIntoArray($moneyOutput, $output_all, "all");

//怪物掉落
$condArrMonOut = array( $moneyPlus, ' type=30004 ');
...
//境界提升
$condArrJingjieExpend =  array( $moneyMinus , ' type in (30048,30049,30050) ');
...
//家族捐献
$condArrFamilyExpend =  array( $moneyMinus , ' type in (30051) ');
...
//命符(猎命)消耗
$condArrHuntlifeExpend =  array( $moneyMinus , ' type in (30159) ');
...
//其他
$condArrOtherExpend =  array( $moneyMinus , ' type not in (30002,30003,30018,30019,30027,30028,30029,30013,30014,30015,30016,30017,30048,30049,30050,30051,30159) ');
...
$condArrBuyGoldCirc = array( $moneyMinus , ' type = 30019 ', ' item_id = 10006 ');	// 元宝id=10006
...
$smarty->display("module/money/money_output_and_usage.tpl");
