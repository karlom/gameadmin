...
if(isPost()){
	...
	$result = interfaceRequest("opentime",$params );
	if($result['result'] == 1) {
...
$result = interfaceRequest("getopentime",array());
...
$attention = "注意，这里是 ".$serverCname." 服，如不清楚开服时间作用请不要随便操作！";
...
$smarty->display("module/system/change_online_time.tpl");