...
<head>
	...
	<title><{$lang->menu->roleJingjieRank}></title>
...
<body>
	<div id="position">
		<b><{$lang->menu->class->rankData}>：<{$lang->menu->roleJingjieRank}></b>
	</div>
	...
	<div><h3><{$lang->menu->roleJingjieRank}>：</h3></div>
	<br />
	<{if $viewData}>
	<table class="DataGrid" style="width:960px">
			<tr >
				<th><{$lang->rank->rank}></th>
				<th><{$lang->rank->jingjieLevel}></th>
				<th><{$lang->player->roleName}></th>
				<th><{$lang->rank->yestodayLevel}></th>
			</tr>
