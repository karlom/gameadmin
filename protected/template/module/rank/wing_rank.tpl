...
<head>
	...
	<title><{$lang->menu->wingRank}></title>
...
<body>
	<div id="position">
		<b><{$lang->menu->class->rankData}>：<{$lang->menu->wingRank}></b>
	</div>
	...
	<div><h3><{$lang->menu->wingRank}>：</h3></div>
	<br />
	<{if $viewData}>
	<!-- pageList start -->
	...
	<table class="DataGrid" style="width:960px">
			<tr >
				...
				<th><{$lang->rank->wingName}></th>
				<th><{$lang->page->level}></th>
				<th><{$lang->rank->master}></th>
				<th><{$lang->rank->atk}></th>
			</tr>
