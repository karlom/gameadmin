...
-->
	...
	<{ if $viewData.data }>
		...
		<tr class="alwaysdisplay">
			...
			<th align="center" width="10%"><{ $lang->page->roleName }></th>
			<th align="center" width="10%"><{ $lang->gold->gold }></th>
			<th align="center" width="10%"><{ $lang->gold->bind_gold }></th>
			<th align="center" width="10%"><{ $lang->money->money }></th>
			<th align="center" width="10%"><{ $lang->money->bind_money }></th>
			<th align="center" width="40%"><{ $lang->page->other }></th>
		</tr>
		...
		<{foreach from=$viewData.data item=item key=key name=mainLoop}>
			...
			<tr <{ if $smarty.foreach.mainLoop.index is odd }> class="odd"<{ /if }>>
				<td align="center"><{$item.apply_id}></td> 
				...
				<td align="center"><{$item.bind_gold}></td>
				<td align="center"><{$item.money}></td>
				<td align="center"><{$item.bind_money}></td>
				<td>	
