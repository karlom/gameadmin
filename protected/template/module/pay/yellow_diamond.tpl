...
<body>
	...
	<div id="position">
	<b><{$lang->menu->class->payAndSpand}>：<{$lang->menu->yellowDiamondOpen}></b>
	</div>
	...
	<br />
	&nbsp;<{$lang->yellow->allCount}>:
	<table height="" cellspacing="0" border="0" class="DataGrid">
		<tr>
			<td width="20%"> &nbsp;<{$lang->yellow->openCount}>: &nbsp; <{$statisticsData.all.open_pt_count}></td>
			<td width="20%"> &nbsp;<{$lang->yellow->openYearCount}>: &nbsp; <{$statisticsData.all.open_year_count}></td>
			<td width="30%"> &nbsp;<{$lang->yellow->maxOpenDayCount}>: &nbsp; <{$statisticsData.all.maxOpen.count}>, &nbsp; <{$statisticsData.all.maxOpen.date}></td>
			<td width="30%"></td>
		</tr>
		<tr>
			<td width="20%"> &nbsp;<{$lang->yellow->renewCount}>: &nbsp; <{$statisticsData.all.renew_pt_role_count}></td>
			<td width="20%"> &nbsp;<{$lang->yellow->renewYearCount}>: &nbsp; <{$statisticsData.all.renew_year_role_count}></td>
			<td width="30%"> &nbsp;<{$lang->yellow->maxRenewDayCount}>: &nbsp; <{$statisticsData.all.maxRenew.count}>, &nbsp; <{$statisticsData.all.maxRenew.date}></td>
			<td width="30%"></td>
		</tr>
		<tr>
			<td width="20%"> &nbsp;<{$lang->yellow->renewRoleCount}>: &nbsp; <{$statisticsData.all.renew_pt_count}></td>
			<td width="20%"> &nbsp;<{$lang->yellow->renewYearRoleCount}>: &nbsp; <{$statisticsData.all.renew_year_count}></td>
			<td width="30%"> &nbsp;<{$lang->yellow->maxRenewDayRoleCount}>: &nbsp; <{$statisticsData.all.maxRoleRenew.count}>, &nbsp; <{$statisticsData.all.maxRoleRenew.role_name}>, &nbsp; <{$statisticsData.all.maxRoleRenew.date}></td>
			<td width="30%"></td>
		</tr>
	</table>
	<br />
	...
	<table height="" cellspacing="0" border="0" class="DataGrid">
		<tr>
			<td width="30%"> &nbsp;<{$lang->yellow->openCount}>: &nbsp; <{$statisticsData.date.open_pt_count}></td>
			<td width="30%"> &nbsp;<{$lang->yellow->openYearCount}>: &nbsp; <{$statisticsData.date.open_year_count}></td>
			<td width="40%"></td>
		</tr>
		<tr>
			<td width="30%"> &nbsp;<{$lang->yellow->renewCount}>: &nbsp; <{$statisticsData.date.renew_pt_role_count}></td>
			<td width="30%"> &nbsp;<{$lang->yellow->renewYearCount}>: &nbsp; <{$statisticsData.date.renew_year_role_count}></td>
			<td width="40%"></td>
		</tr>
		<tr>
			<td width="30%"> &nbsp;<{$lang->yellow->renewRoleCount}>: &nbsp; <{$statisticsData.date.renew_pt_count}></td>
			<td width="30%"> &nbsp;<{$lang->yellow->renewYearRoleCount}>: &nbsp; <{$statisticsData.date.renew_year_count}></td>
			<td width="40%"></td>
		</tr>
	</table>
	...
	<table cellspacing="1" cellpadding="3" border="0" class='table_list' >
		<tr align="center" class='table_list_head'>
	        ...
	        <td width="10%"><{$lang->yellow->isYellowDiamond}></td>
	        <td width="10%"><{$lang->yellow->isYellowYearDiamond}></td>
	        <td width="10%"><{$lang->yellow->yellowDiamondLevel}></td>
	        <td width="10%"><{$lang->yellow->openTime}></td>
	        <td width="10%"><{$lang->yellow->openType}></td>
		</tr>
	...
	<{foreach name=loop from=$viewData item=item}>
		<tr align="center" class='<{cycle values="trEven,trOdd"}>'>
			...
			<td><{$item.level}></td>
			<td><{$item.yellowDiamond}></td>
			<td><{$item.yellowDiamondYear}></td>
			<td><{$item.yellowDiamondLv}></td>
			<td><{$item.mtime|date_format:'%Y-%m-%d %H:%M:%S'}></td>
			<td><{if $item.isYear==1}><{$lang->yellow->year}><{else}><{$lang->yellow->putong}><{/if}></td>
		</tr>
	<{foreachelse}>
