...
<title><{$lang->menu->AllgoldUserAnalyse2}></title>
</head>
...
<div id="position"><{$lang->menu->class->spendData}>：<{$lang->menu->AllgoldUserAnalyse2}></div>
...
<{ if $gold_decrease_statistics || $gold_increase_statistics}>
	<table class="DataGrid sortable table_list" cellspacing="0" style="margin-bottom:20px;">
		<caption class="table_list_head">
			...
			<{$lang->gold->usageOfGold}>
			<font style="color:#f00;">(<{$lang->gold->gold_decrease}>)</font>
