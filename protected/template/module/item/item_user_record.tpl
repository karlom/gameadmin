...
<tr class='table_list_head'>
		...
		<th align="center" width="35%"><{$lang->item->itemName}></th>
		<th align="center" width="5%"><{$lang->item->color}></th>
		<th align="center" width="10%"><{$lang->item->quality}></th>
	...
	<tr class='<{cycle values="trEven,trOdd"}>'>
		...
		<td align="center"><{$dictColor[$item.color]}></td>
		<td align="center"><{if $item.quality}> <{$dictQuality[$item.quality]}> <{else}> - <{/if}></td>
