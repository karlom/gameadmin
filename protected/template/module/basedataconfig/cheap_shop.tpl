...
<html>
<head>
<title><{$lang->menu->cheapShop}></title>
...
<body>
<div id="position">
<b><{$lang->menu->class->baseDataConfig}>：<{$lang->menu->cheapShop}></b>
</div>
<{if $msg}>
	...
	<table class="table_list" >
		...
		<tr>
			...
			<td>
				...
				<label><input type="radio" name="date_type" value="1" <{if $cheapShopShow.date_type eq 1}>checked=checked<{/if}>/>按开服天数</label>
			</td>
		</tr>
		<{/if}>
    	<tr>
