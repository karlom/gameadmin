...
<body>
<div id="position">
<b><{$lang->menu->class->userInfo}>：<{$lang->menu->petGrowup}></b>
</div> 
...
&nbsp;<{$lang->pet->growType}>:<{html_options options=$typeList selected=$type name='type'}>
...
<thead>
	<tr class='table_list_head'>
		...
		<th align="center" width="5%"><{$lang->pet->oldData}></th>
		<th align="center" width="5%"><{$lang->pet->newData}></th>
		<th align="center" width="10%"><{$lang->pet->isProtected}></th>
		<th align="center" width="10%"><{$lang->pet->growType}></th>
		<th align="center" width="5%"><{$lang->pet->moneyCost}></th>
	</tr>
</thead>
<tbody>
	...
	<tr class='<{cycle values="trEven,trOdd"}>'>
		...
		<td align="center"><{$item.old_data}></td>
		<td align="center"><{$item.new_data}></td>
		<td align="center">
			<{if $item.protect_flag eq 0}>
				<{$lang->pet->yes}>
			<{else}>
				<{$lang->pet->no}>
			<{/if}>
