...
<!--  
<div id="position">
<b><{$lang->menu->class->userInfo}>：<{$lang->menu->shipStatistics}></b>
</div> 
-->
...
<{*船运颜色分布统计：（玩家领取船运的颜色）*}>
<{$lang->player->initColorStatistics}>：
<table cellspacing="1" cellpadding="3" border="0" class='DataGrid table_list' >
	<tr class='table_list_head'>
...
<{*刷新船运颜色分布统计：（玩家刷新船运并领取的灵兽颜色）*}>
<{$lang->player->refreshColorStatistics}>：
<table cellspacing="1" cellpadding="3" border="0" class='DataGrid table_list' >
	<tr class='table_list_head'>
	<{foreach name=loop from=$dictColor item=item}>
        <th><{$item}></th>
...
<{*刷新船运颜色次数分布统计：（玩家刷新船运并领取的灵兽颜色及次数分布）*}>
<{$lang->player->refreshColorTimesStatistics}>：
<table cellspacing="1" cellpadding="3" border="0" class='DataGrid table_list' >
	<tr class='table_list_head'>
