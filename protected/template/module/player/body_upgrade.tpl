...
<!-- 
<div id="position">
<b><{$lang->menu->class->userInfo}>：<{$lang->menu->bodyUpgrade}></b>
</div> 
-->
<!-- Start 成功信息提示 -->
<{if $successMsg}>
...
<table style="width: 50%;" cellspacing="1" cellpadding="3" border="0" class="DataGrid table_list" >
	<tr class='table_list_head'>
		...
		<td width="20%"><{$lang->page->detailDeal}></td>
        <td width="10%"><{$lang->player->status}></td>
