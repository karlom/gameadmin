...
<body>
<div id="position">
<b><{$lang->menu->class->userInfo}>：<{$lang->menu->petAdvance}></b>
</div> 
...
&nbsp;<{$lang->pet->advanceWay}>:<{html_options options=$dictAdvanceWay selected=$advanceWay name='advance_way'}>
...
<thead>
	<tr class='table_list_head'>
		...
		<th align="center" width="5%"><{$lang->pet->petType}></th>
		<th align="center" width="10%"><{$lang->pet->petUID}></th>
		<th align="center" width="5%"><{$lang->pet->petLevel}></th>
		<th align="center" width="5%"><{$lang->pet->color}></th>
		<th align="center" width="5%"><{$lang->pet->advanceLevel}></th>
		<th align="center" width="10%"><{$lang->pet->advanceWay}></th>
		<th align="center" width="20%"><{$lang->pet->advanceDetail}></th>
		<th align="center" width="5%"><{$lang->pet->advanceResult}></th>
	</tr>
</thead>
<tbody>
	...
	<tr class='<{cycle values="trEven,trOdd"}>'>
		...
		<td align="center"><{$item.advance_level}></td>
		<td align="center"><{$dictAdvanceWay[$item.type]}></td>
		<td align="center">
			<{if $item.type eq 1}>
				<{$lang->pet->eaten}><{$lang->pet->petUID}>: <{$item.item_id}>
			<{elseif $item.type eq 2}>
				<{$lang->pet->eaten}><{$lang->pet->petType}>: <{$itemList[$item.item_id]}>
			<{else}>
				-
			<{/if}>
		</td>
		<td align="center">
			<{if $item.flag == 1}>
				<font color="green"><{$lang->pet->success}></font>
			<{else}>
				<font color="red"><{$lang->pet->fail}></font>
			<{/if}>
		</td>
	</tr>
	<{/foreach}>
