...
<title><{$lang->menu->familyRestore}></title>
...
<form action="?action=search" id="frm" method="post" >
	...
	<br />
	<div class="red">&nbsp;&nbsp;PS:角色名和账号名填其中一个即可，推荐用账号</div>
	...
	<table class="DataGrid" cellspacing="0">
		<tr>
			<td align="right">恢复到家族：</td>
			<td><input type="text" name="newFamilyName" id="newFamilyName" size="24" value="<{$newFamilyName}>" /></td>
	    </tr>
		<tr>
			<th colspan="5"><input type="button" name="btnRestore" id="btnRestore" value="<{$lang->page->restoreData}>" /></th>
	    </tr>
		<tr>
			<th colspan="5" align="right">恢复家族数据，所有成员将被踢下线</th>
	    </tr>
	</table>
	<br />
	<{/if}>
